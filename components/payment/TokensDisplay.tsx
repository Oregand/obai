      ...
      {isTooltipOpen && (
        ...
        >
          ...
          <p className="text-xs text-white opacity-70 mb-3">
            Tokens are used for AI interactions, tipping personas, and unlocking premium content.
          </p>
          <div className="flex flex-col space-y-2">
            ...
            <button
              ...
              className="w-full py-2 px-3 text-xs font-medium text-white bg-secondary hover:bg-secondary-light rounded-md border border-primary/30"
            >
              Add Crypto Wallet
            </button>
          </div>
