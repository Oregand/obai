          ...
          <div className="space-y-4 md:col-span-2">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-midnight-lighter text-gray-900 dark:text-white"
                placeholder="A friendly AI assistant that helps with everyday questions."
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-midnight-lighter text-gray-900 dark:text-white"
                placeholder="You are a friendly, helpful AI assistant. You are enthusiastic and enjoy helping people with a variety of tasks."
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.tokenRatePerMessage}
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-midnight-lighter text-gray-900 dark:text-white"
                />
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.lockMessageChance}
                  onChange={handleChange}
                  className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-midnight-lighter text-gray-900 dark:text-white"
                />
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.lockMessagePrice}
                  onChange={handleChange}
                  className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-midnight-lighter text-gray-900 dark:text-white"
                />
              </div>
          ...
          <div className="space-y-4 md:col-span-2">
            ...
            <div>
              ...
              <input
                ...
                value={formData.exclusivityMultiplier}
                onChange={handleChange}
                className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-midnight-lighter text-gray-900 dark:text-white"
              />
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
